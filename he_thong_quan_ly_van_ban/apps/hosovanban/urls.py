...
# URL hồ sơ văn bản: danh sách, thêm/sửa/xóa, chi tiết và API thêm văn bản vào hồ sơ.
urlpatterns = [
    # Màn danh sách và thao tác hồ sơ.
    ...
    # Chi tiết văn bản nằm trong hồ sơ và thao tác gỡ văn bản khỏi hồ sơ.
