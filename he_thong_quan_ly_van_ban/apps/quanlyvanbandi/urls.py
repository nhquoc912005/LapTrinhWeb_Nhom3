...
# URL văn bản đi: danh sách, thêm/sửa/chi tiết, phê duyệt, hoàn trả, ban hành và API.
urlpatterns = [
    # Màn danh sách và form thêm/sửa/chi tiết văn bản đi.
    ...
    # Các thao tác nghiệp vụ theo quyền: duyệt, hoàn trả, ban hành, xóa và ký số.
    ...
    path("van-ban-di/<int:vb_pk>/ky-so/", views.api_ky_so_van_ban, name="api_ky_so_van_ban"),

    # AJAX APIs phục vụ popup chọn đơn vị/phòng ban/người nhận.
