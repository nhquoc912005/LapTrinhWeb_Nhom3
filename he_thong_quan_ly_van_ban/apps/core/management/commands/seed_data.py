...
NGUOI_DUNG_TCT = [
    ...
    ("Nguyen Van Hung", "hung.gd@atax.vn", "0901234567", "Lanh Dao", "hung.gd", "123"),
    ("Le Thi Lan", "lan.pgd@atax.vn", "0912345678", "Lanh Dao", "lan.pgd", "123"),
    # Phong Ke Toan
    ("Tran Thi Mai", "mai.kt@atax.vn", "0923456789", "Chuyen Vien", "mai.kt", "123"),
    ("Pham Van Duc", "duc.kt@atax.vn", "0934567890", "Chuyen Vien", "duc.kt", "123"),
    ("Nguyen Thi Hoa", "hoa.kt@atax.vn", "0945678901", "Chuyen Vien", "hoa.kt", "123"),
    # Phong Kiem Toan
    ("Do Van Minh", "minh.kta@atax.vn", "0956789012", "Lanh Dao", "minh.kta", "123"),
    ("Ngo Thi Thu", "thu.kta@atax.vn", "0967890123", "Chuyen Vien", "thu.kta", "123"),
    ("Bui Van Nam", "nam.kta@atax.vn", "0978901234", "Chuyen Vien", "nam.kta", "123"),
    # Phong Tu Van Thue
    ("Vo Thi Bich", "bich.tvt@atax.vn", "0989012345", "Chuyen Vien", "bich.tvt", "123"),
    ("Ho Van Long", "long.tvt@atax.vn", "0990123456", "Chuyen Vien", "long.tvt", "123"),
    # Phong HC NS
    ("Nguyen Van Tu", "tu.hcns@atax.vn", "0901357924", "Lanh Dao", "tu.hcns", "123"),
    ("Tran Thi Kim", "kim.hcns@atax.vn", "0912468135", "Chuyen Vien", "kim.hcns", "123"),
    # Phong Dao Tao Chat Luong
    ("Le Van Thanh", "thanh.dt@atax.vn", "0923579246", "Chuyen Vien", "thanh.dt", "123"),
    ("Dinh Thi Nga", "nga.dt@atax.vn", "0934680357", "Chuyen Vien", "nga.dt", "123"),
    # Van thu
    ("Truong Thi Khanh", "khanh.vt@atax.vn", "0945791468", "Van Thu", "khanh.vt", "123"),
    ("Pham Van Hai", "hai.vt@atax.vn", "0956802579", "Van Thu", "hai.vt", "123"),
]

NGUOI_DUNG_HN = [
    ("Tran Van Khoa", "khoa.hn@atax.vn", "0243112233", "Lanh Dao", "khoa.hn", "123"),
    ("Nguyen Thi Linh", "linh.hn@atax.vn", "0243223344", "Chuyen Vien", "linh.hn", "123"),
    ("Do Thi Thanh", "thanh.hn@atax.vn", "0243334455", "Chuyen Vien", "thanh.hn", "123"),
    ("Le Van Nam", "nam.hn@atax.vn", "0243445566", "Lanh Dao", "nam.hn", "123"),
    ("Pham Thi Hue", "hue.hn@atax.vn", "0243556677", "Chuyen Vien", "hue.hn", "123"),
    ("Bui Van An", "an.hn@atax.vn", "0243667788", "Chuyen Vien", "an.hn", "123"),
    ("Vo Thi Xuan", "xuan.hn@atax.vn", "0243778899", "Chuyen Vien", "xuan.hn", "123"),
    ("Ho Van Phuc", "phuc.hn@atax.vn", "0243889900", "Lanh Dao", "phuc.hn", "123"),
    ("Nguyen Van Tuan", "tuan.hn@atax.vn", "0243990011", "Chuyen Vien", "tuan.hn", "123"),
    ("Tran Thi Dung", "dung.hn@atax.vn", "0244011223", "Van Thu", "dung.hn", "123"),
    ("Le Thi Hong", "hong.hn@atax.vn", "0244122334", "Chuyen Vien", "hong.hn", "123"),
    ("Pham Van Thi", "thi.hn@atax.vn", "0244233445", "Chuyen Vien", "thi.hn", "123"),
]

NGUOI_DUNG_HCM = [
    ("Nguyen Thi Phuong", "phuong.hcm@atax.vn", "0281234560", "Lanh Dao", "phuong.hcm", "123"),
    ("Le Van Cuong", "cuong.hcm@atax.vn", "0282345671", "Chuyen Vien", "cuong.hcm", "123"),
    ("Tran Thi Loan", "loan.hcm@atax.vn", "0283456782", "Chuyen Vien", "loan.hcm", "123"),
    ("Do Van Hung", "hung.hcm@atax.vn", "0284567893", "Lanh Dao", "hung.hcm", "123"),
    ("Ngo Thi Yen", "yen.hcm@atax.vn", "0285678904", "Chuyen Vien", "yen.hcm", "123"),
    ("Bui Thi My", "my.hcm@atax.vn", "0286789015", "Chuyen Vien", "my.hcm", "123"),
    ("Vo Van Hai", "hai.hcm@atax.vn", "0287890126", "Chuyen Vien", "hai.hcm", "123"),
    ("Pham Thi Thu", "thu.hcm@atax.vn", "0288901237", "Lanh Dao", "thu.hcm", "123"),
    ("Ho Van Lam", "lam.hcm@atax.vn", "0289012348", "Chuyen Vien", "lam.hcm", "123"),
    ("Nguyen Van Kiet", "kiet.hcm@atax.vn", "0281123459", "Van Thu", "kiet.hcm", "123"),
    ("Tran Van Son", "son.hcm@atax.vn", "0282234560", "Chuyen Vien", "son.hcm", "123"),
    ("Le Thi Ngoc", "ngoc.hcm@atax.vn", "0283345671", "Chuyen Vien", "ngoc.hcm", "123"),
]

NGUOI_DUNG_DN = [
    ("Nguyen Van Bao", "bao.dn@atax.vn", "0236112233", "Lanh Dao", "bao.dn", "123"),
    ("Tran Thi Nhu", "nhu.dn@atax.vn", "0236223344", "Chuyen Vien", "nhu.dn", "123"),
    ("Le Van Hieu", "hieu.dn@atax.vn", "0236334455", "Chuyen Vien", "hieu.dn", "123"),
    ("Do Thi Cam", "cam.dn@atax.vn", "0236445566", "Lanh Dao", "cam.dn", "123"),
    ("Pham Van Loc", "loc.dn@atax.vn", "0236556677", "Chuyen Vien", "loc.dn", "123"),
    ("Bui Thi Tuyet", "tuyet.dn@atax.vn", "0236667788", "Chuyen Vien", "tuyet.dn", "123"),
    ("Vo Van Tri", "tri.dn@atax.vn", "0236778899", "Chuyen Vien", "tri.dn", "123"),
    ("Ho Thi Nhung", "nhung.dn@atax.vn", "0236889900", "Lanh Dao", "nhung.dn", "123"),
    ("Ngo Van Dai", "dai.dn@atax.vn", "0236990011", "Chuyen Vien", "dai.dn", "123"),
    ("Nguyen Thi Hien", "hien.dn@atax.vn", "0237011223", "Van Thu", "hien.dn", "123"),
    ("Tran Van Binh", "binh.dn@atax.vn", "0237122334", "Chuyen Vien", "binh.dn", "123"),
    ("Le Thi Truc", "truc.dn@atax.vn", "0237233445", "Chuyen Vien", "truc.dn", "123"),
]
